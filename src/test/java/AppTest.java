...
//     Stylist myStylist = new Stylist ("Stylist Ann");
//     myStylist.save();
//     String stylistPath = String.format("http://localhost:4567/stylists/%d", myStylist.getId());
//     goTo(stylistPath);
//     click("a", withText ("Manage Stylist list"));
//     assertThat(pageSource()).contains("Stylist Jane");
//   }

//   @Test
//   public void getClientupdateClientPage() {
//     Stylist myStylist = new Stylist ("Stylist Jane");
//     myStylist.save();
//     myStylist.getId();
//     Client oldClient = new Client ("Client Ann", myStylist.getId());
//     oldClient.save();
//     String clientPath = String.format("http://localhost:4567/stylists/%d", myStylist.getId());
//     goTo(clientPath);
//     click("a", withText ("Update Client Name"));
//     Client newClient = new Client ("Client Jane updated", myStylist.getId());
//     newClient.save();
//     goTo(clientPath);
//     assertThat(pageSource()).contains("Client Jane updated");
//   }
